...
Laporan Pelanggan
            ...
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-left mt-4 bawah">
                    <!-- Tombol Download PDF -->
                    <a href="{{ route('laporan.download') }}" class="btn btn-success" style="margin-left: 20px;">
                        <i class="bi bi-download"></i> Download as PDF
                    </a>

                    <!-- Tombol View PDF -->
                    <a href="{{ route('laporan.view') }}" target="_blank" class="btn btn-info" style="margin-left: 40px;">
