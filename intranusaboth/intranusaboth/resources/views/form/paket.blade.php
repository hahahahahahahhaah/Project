            ...
            <div class="col-md-7 col-lg-5">
                <div class="wrap">
                    ...
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="{{ route('form.paket') }}" method="POST" onsubmit="return validateForm()">
                            @csrf
                            <div class="form-group mt-3">
                                <div class="qa-section">
                                    @foreach([
                                        ['10mbps', '166,500', '1-2', 'Tidak disarankan', '3-5', '2-3', '1-2'],
                                        ['15mbps', '194,250', '2-3', '1', '5-7', '3-4', '2-3'],
                                        ['20mbps', '222,000', '3-4', '1-2', '7-10', '4-5', '3-4'],
                                        ['35mbps', '249,750', '4-5', '1-3', '10-15', '6-8', '4-6'],
                                        ['50mbps', '333,000', '6-10', '2-4', '15-20', '8-12', '5-8']
                                    ] as $paket)
                                    <details>
                                        <summary>{{ $paket[0] }} dengan tarif Rp {{ $paket[1] }}/Bulan</summary>
                                        <p>- Streaming Video (HD) : {{ $paket[2] }} Perangkat</p>
                                        <p>- Streaming Video (4k) : {{ $paket[3] }} Perangkat</p>
                                        <p>- Browsing Media Sosial : {{ $paket[4] }} Perangkat</p>
                                        <p>- Video Call (HD) : {{ $paket[5] }} Perangkat</p>
                                        <p>- Gaming Online : {{ $paket[6] }} Perangkat</p>
                                        <label>
                                            <input type="radio" name="paket" value="{{ $paket[0] }}"> Pilih Paket Ini
                                        </label>
                                    </details>
                                    @endforeach
                                </div>
